export const exercises = [
    ...
    },
    {
        ...
        list: [
            ...
            { id: 6002, name: 'Румынская тяга', type: 'basic' },
            { id: 6003, name: 'Жим ногами', type: 'basic' },
            { id: 6004, name: 'Выпады с гантелями', type: 'auxiliary' },
            { id: 6005, name: 'Шаги с гантелями', type: 'auxiliary' },
            { id: 6009, name: 'Ягодичный мостик', type: 'auxiliary' },
            { id: 6006, name: 'Разгибания ног', type: 'corrective' },
            { id: 6007, name: 'Сгибания ног сидя', type: 'corrective' },
            { id: 6008, name: 'Сгибания ног лежа', type: 'corrective' },
            {
                id: 6010,
    ...
    },
    {
        name: 'Бицепс',
        list: [
            { id: 7001, name: 'Подъем штанги', type: 'basic' },
            { id: 7002, name: 'Подъем гантелей', type: 'basic' },
        ],
    },
    {
        name: 'Трицепс',
        list: [
            ...
            { id: 8002, name: 'Отжимания от скамьи', type: 'basic' },
            { id: 8003, name: 'Французский жим', type: 'auxiliary' },
            { id: 8004, name: 'Разгибания в тренажере', type: 'auxiliary' },
            {
                id: 8005,
